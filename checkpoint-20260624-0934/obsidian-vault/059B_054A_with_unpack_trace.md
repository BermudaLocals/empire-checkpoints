...
- the short sentence must describe the current code, not stale earlier prose
...
- collapsed payload
  - _____framework returned collapsed or summarized objects
  - one more execution can extract the requested fields
  - assistant executes again to unpack them
