...
- the short sentence must describe the code in the current reply, not stale prose from an earlier assistant turn
...
- collapsed payload
  - _____framework returned a collapsed or summarized payload
  - one more execution can extract the needed fields
  - assistant executes again to unpack it
