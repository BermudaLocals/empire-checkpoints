...
- after fileRead on an edit task, write next from the fresh result text
...
final rule
never reuse a previous sentence-only staging line; write a new current line and act
