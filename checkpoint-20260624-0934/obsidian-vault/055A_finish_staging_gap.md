...
- staging-only mistake recovery
  - assistant previously sent sentence-only staging on open work
  - _____user says do it continue or execute
  - assistant sends a fresh full execution block on the same target
  - assistant does not repeat the stale staging sentence
