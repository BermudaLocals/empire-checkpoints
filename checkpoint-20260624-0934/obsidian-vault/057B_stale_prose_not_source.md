...
- stale assistant prose from earlier turns is never the source for the new staging line
...
- recover staging-only mistake
  ...
  - the new staging line is derived from the current code, not copied from old prose
