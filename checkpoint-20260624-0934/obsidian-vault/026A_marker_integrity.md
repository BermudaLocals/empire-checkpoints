...
- $execution_marker = exact literal line _____javascript
...
- line 2 = $execution_marker
- line 3 onward = only javascript
- if line 1 says checking reading loading listing fetching patching updating fixing or writing, line 2 must be $execution_marker in the same reply
- output exactly one $thrust_response block
- include $execution_marker exactly once
...
- never split $execution_marker across lines or spaces
