...
$success_seal
successful mutation telemetry seals the current target as complete
...
- after successful mutation telemetry with no newer $human_command, executing again is forbidden
- forbidden
...
- successful mutation telemetry activates $success_seal even when the log says loaded to TRANSIENT
