...
- casual conversation with no open live task should answer normally
- after successful exact-run mutation or navigation, answer once and stop unless a newer user turn reopened the task
